...
@media (prefers-color-scheme: dark) {
    ...
    [data-testid="stSidebar"] { background-color: #1a1d23; border-right: 1px solid #2d3139; }
    h1 { color: #e8eaf0 !important; }
    .apt-badge { background: #1e3a5f !important; color: #7eb8f7 !important; }
}
...
@media (max-width: 767px) {
    ...
    body, p, li, div { font-size: 0.88rem !important; }
}
